...
export const FIXED_SCENARIO_2: Scenario = {
  title: '霧の密室',
  synopsis:
    '孤島のゴシック城ホテルで開催された白河財閥の親族会議。翌朝、会長の白河啓一が自室の密室で絞殺体となって発見された。嵐により本土との連絡が絶たれた状況で、招待された6名の中に犯人がいる。',
  setting: '霧に包まれた孤島に建つゴシック様式の古城ホテル。嵐で本土との連絡は絶たれている。',
  ...
  suspects: [
    {
      ...
      investigation_dialog: {
        greeting: '……調査ですか。私はこの財閥の経理を担当しています。何でも聞いてください。',
        statements: [
          '会長の死は本当に信じられません。20年間お仕えしてきた方なのに。',
          '23時以降は書斎で資料整理をしていました。一度も書斎を出ていません。',
          'マスターキーは事務局から借りています。会計書類の確認で各部屋に入ることがありますから。ただし昨夜は使っていません。',
          '廊下で足音を聞いたという方がいるようですが、この城は音が響くので別の人間だと思います。',
          '横領？ そんな馬鹿な。20年間清廉に仕事をしてきました。帳簿を調べれば分かります。',
        ],
      },
  ...
  rooms: [
    {
      ...
      name: '塔の寝室',
      type_id: 'bedroom',
      description: '城の最上階にある被害者の部屋。絞殺体が発見された現場。窓枠に工具の傷跡が残る。',
    ...
    },
    {
      ...
      name: '書斎',
      type_id: 'study',
      description: '分厚い書棚が並ぶ静かな部屋。西村はここにいたと主張。金庫が備え付けられている。',
    ...
    },
    {
      ...
      name: '図書室',
      type_id: 'library',
      description: '古い洋書が並ぶ広い部屋。尾崎と藤田が作業をしていた場所。',
    ...
    },
    {
      ...
      name: 'ダイニング',
      type_id: 'dining_room',
      description: '長いテーブルが特徴的な食堂。田中が深夜まで飲酒していた。',
    ...
    },
    {
      ...
      name: '寝室棟廊下',
      type_id: 'hallway',
      description: '塔の寝室へと続く石畳の廊下。泥足跡とマスターキーが発見された。',
  ...
  evidence: [
    {
      ...
      name: '絹の紐',
      category_id: 'fabric',
      description: 'カーテンの飾り紐として使われていた絹製の紐。被害者の首に使用された凶器。',
      is_fake: false,
      relevance: '凶器。被害者の部屋のカーテンから引き抜かれた形跡がある。',
      examination_notes:
        '繊維の分析から被害者の首の索状痕と一致することが確認された。紐の端に皮膚組織が付着しており、激しい絞扼が行われたことを示す。部屋のカーテンに固定するための金具が外れており、意図的に取り外されたと考えられる。',
    },
    {
      id: 'ledger_copy',
      name: '横領帳簿のコピー',
      category_id: 'document_contract',
      description: '財閥の経理書類のコピー。特定の口座への不自然な資金移動が複数記録されている。',
      is_fake: false,
      relevance: '横領の証拠。承認印と照合可能なインク痕が残る。',
      examination_notes:
        '書類に押された承認印は特殊なインクで作られており、照合可能な識別子を含む。この書類が翌朝弁護士に渡される予定だったとすれば、横領の当事者には強い動機が生じる。被害者が金庫に保管しており、金庫の鍵を持つ人物しかコピーを入手できない。',
    },
    {
      id: 'window_tool',
      name: '窓枠の工具痕',
    ...
    },
    {
      ...
      name: '金のカフスボタン',
      category_id: 'jewelry',
      description: '18金製のカフスボタン。片方のみ発見。「N.K.」のイニシャルが彫られている。',
      is_fake: false,
      relevance: '犯人の落とし物。イニシャルが特定の人物を示す。',
      examination_notes:
        'カフスボタンに彫られた「N.K.」は西村健二（Nishimura Kenji）のイニシャルを逆にしたものと思われる。被害者の部屋で発見されたことは、この人物が昨夜部屋に立ち入ったことを示す。格闘の際に外れたとみられ片方が室内に残されていた。',
    },
    {
      id: 'victim_note',
      name: '被害者のメモ',
      category_id: 'document_letter',
      description: '被害者の手書きのメモ。「K・N 横領確認済 弁護士に提出 翌10時」と記されている。',
      is_fake: false,
      relevance: '横領発覚の記録。被害者が翌朝に証拠提出を計画していた証拠。',
      examination_notes:
        '筆跡は被害者のものと一致する。「K・N」は特定人物のイニシャルと解釈できる。「翌10時」は会議開始前に弁護士と個別面談を設定していたことを示す。このメモの内容が漏れていたとすれば「K・N」の人物には緊急の動機が生じる。',
    },
    {
      id: 'master_key',
      name: 'マスターキー',
