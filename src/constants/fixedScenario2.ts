...
const FIXED_ACCUSATION_DATA_2: AccusationScenarioData = {
  ...
  near_defeat_wrong_suspect_text:
    '探偵の推理は誤った方向を向いていた。\n真犯人は密室の謎とともに、吹雪の山荘から静かに姿を消した。\n白河邸の長い夜は、真実が葬られた沈黙の中で幕を閉じた。',
}
          ...
          bystander_reactions: [
            {
              ...
              text: '（立ち上がる）……西村さん、父が帳簿を弁護士に渡すつもりだったって——それを知っていたんですか？',
            },
            {
              suspectId: 'tanaka_goro',
              text: 'まさか……西村、お前が横領を……。啓一はそれを知っていたのか。許せんぞ。',
            },
          ],
        },
        window_tool: {
  ...
  evidence_combinations: [
    {
      ...
      is_critical: true,
      refutation_text:
        '帳簿のコピーと隠し口座の入金明細が揃った。十五年間、少しずつ積み重ねられた三億円超の横領——その全容が証拠として確定する。明日弁護士に渡されるはずだったこの証拠の存在を知っていた者が、その夜に動いた。',
    },
    {
      ...
      is_critical: true,
      refutation_text:
        '被害者の部屋で発見されたイニシャル「N.K.」のカフスボタンと、廊下に落ちていたマスターキー——二点が示す行動は一本の筋で繋がる。合鍵を使って部屋に侵入し、絞殺を実行した者がいる。「書斎にいた」というアリバイは、この物証の前で崩れ落ちる。',
    },
    {
      ...
      is_critical: true,
      refutation_text:
        '窓枠の工具痕とマスターキーが示すのは、犯人が絞殺後に窓から脱出して外側から施錠し、密室を偽装したトリックだ。吹雪の夜に素足で窓の外へ出た痕跡——それは「書斎にいた」という証言と真っ向から矛盾する。',
    },
    {
      ...
      is_critical: false,
      refutation_text:
        '被害者のメモには翌朝十時に弁護士へ証拠提出の予定が記され、帳簿のコピーがその証拠だった。発覚の瀬戸際に追い詰められた者が、その夜に動く以外の選択肢を持てなかったことを、二点の証拠が物語っている。',
    },
  ],
