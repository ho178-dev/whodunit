...
export const FIXED_SCENARIO: Scenario = {
  ...
  suspects: [
    {
      ...
      confession_statement:
        '……（長い沈黙。薄い笑みがゆっくりと消えていく）やはり、辿り着いたか。いい探偵だ。そう——私がやった。おじさんが遺言書を書き換えたと知った瞬間、全てが終わった気がした。借金、失敗、そして裏切り。あの金庫の中の紙切れを見た時、頭の中で何かが弾けた。……後悔はない。',
    ...
    },
    {
      ...
      investigation_dialog: {
        ...
        statements: [
          '叔父はお金に厳しい人だったわ。私への貸付金の返済期限が来週で、プレッシャーを感じていたのは本当。でも——だからって殺したりしない。信じてほしいの。',
    ...
    },
    {
      ...
      investigation_dialog: {
        ...
        statements: [
          ...
          '昨晩21:30頃から図書室にいた。……正確に言うと、アコニチンに関する医学文献を読んでいたわ。偶然よ。患者に関係する研究をしていただけ。',
      ...
      evidence_reactions: {
        ...
        handkerchief: {
          reaction: 'このハンカチのイニシャル…S.M.？参加者の中に該当する人がいるわね。',
          behavior: 'calm',
        },
        diary_entry: {
  ...
  evidence: [
    ...
    },
    {
      ...
      is_fake: true,
      first_impression:
        'アコニチンの致死量を計算したと思われる数式が走り書きされている。体重70kgへの投与量が精密に記されており、これを書いた人物が事前に毒殺を計画していた証拠に見える。筆跡を解析すれば犯人を特定できるかもしれない。',
    ...
    },
    {
      ...
      category_id: 'fabric',
      description:
        '被害者の席の真横、ダイニングのテーブル下に落ちていた上質な白い麻のハンカチ。角には濃紺の糸で「S.M.」のモノグラムが丁寧に刺繍されている。誰かがここに立っていた証だ。',
      is_fake: false,
      relevance: '特定のイニシャルが刺繍されている。犯行現場付近に残された物証。',
      examination_notes:
        '「S.M.」のイニシャルに該当する参加者を確認する必要がある。重要なのは発見場所だ——被害者の座席の真横という位置は、ワイングラスに毒を混入する際に身をかがめた拍子に落とした可能性を強く示唆している。晩餐会の席順と照らし合わせれば、誰がそこに立てたかが絞り込める。',
    },
    {
      id: 'torn_letter',
      name: '破られた手紙の断片',
