...
export const FIXED_SCENARIO: Scenario = {
  ...
  suspects: [
    ...
    },
    {
      ...
      investigation_dialog: {
        ...
        statements: [
          ...
          '遺言のことで叔父と揉めていた人がいるらしいの。それに鬼頭さんも怪しいのよ。叔父に何か弱みを握られていたみたいだし。',
          '部屋に戻る途中の22:00頃、誰かが廊下をキッチン方向へ向かうのを見たの。暗くて顔までは…でも男性だったわ。',
    ...
    },
    {
      ...
      investigation_dialog: {
        ...
        statements: [
          ...
          '22:00頃、晩餐会の席を離れた人間がいた。戻ってきた時に顔色が悪かったな。…赤井先生も気になるが、あの女は毒の知識がある。',
    ...
    },
    {
      ...
      investigation_dialog: {
        ...
        statements: [
          ...
          '23:00頃、図書室から廊下に出たら、キッチン方向から誰かが来るのが見えたわ。急いでいる様子だった。暗かったけれど男性よ。',
        ],
      },
      evidence_reactions: {
        poison_bottle: {
    ...
    },
    {
      ...
      investigation_dialog: {
        ...
        statements: [
          ...
          '法的に申し上げると、遺言書は先月20日に公式に書き換えられています。ある相続人への配分が大きく変更されました。守秘義務上、詳細はお伝えできませんが。',
          '22:30頃、廊下へ出たところ誰かが書斎から出てくるのを目撃しました。手に何かを持ち、顔色が青かった。暗がりで確証は持てませんが。',
        ],
      },
      evidence_reactions: {
        poison_bottle: {
    ...
    },
    {
      ...
      investigation_dialog: {
        ...
        statements: [
          '深夜00:00頃、どなたかが裏口から庭へ出るのを見ました。1時間近く外にいらっしゃいました。暗くてお顔までは…。',
          '庭にはトリカブトが生えています。旦那様は何度か刈り取るよう言っていましたが、なかなか。',
          '昨晩22:00頃からキッチンで後片付けをしていました。その時、キッチンに見知らぬ小瓶があるのに気づきました。翌朝には消えていましたが。',
          '22:30頃、廊下を通ったら書斎からどなたかが出てくるところでした。旦那様がまだご存命の時間帯です。手に何かを持っていました。',
          '旦那様は最近、ある方のことを「困った子だ」と口にされていました。遺言の件で何かお話しされるご予定だったようで。',
        ],
      },
      evidence_reactions: {
        poison_bottle: {
  ...
  evidence: [
    ...
    },
    {
      ...
      description:
        '書斎の金庫に保管されていた遺言書のコピー。先月日付が変更されており、特定の相続人への相続分が削除されている。',
      is_fake: false,
      relevance: '犯行の動機を示す直接的な証拠。',
      examination_notes:
        '先月20日付けで書き換えられた遺言書のコピー。ある相続人への相続分（推定3000万円相当）が完全に削除されている。弁護士の署名と立会日も記載されており、書き換えが正式に行われたことがわかる。これを知った者には強烈な動機が生まれる。',
    },
    {
      id: 'herb_fragment',
      name: 'トリカブトの葉片',
    ...
    },
    {
      ...
      is_fake: false,
      relevance: '事前に毒の量を計算していた証拠。筆跡鑑定により書いた人物を特定できる。',
      examination_notes:
    ...
    },
    {
      ...
      examination_notes:
        '被害者が常に携帯していた金庫の鍵が、なぜか書斎のデスク引き出しに放置されていた。誰かが金庫を開けて遺言書の内容を確認した後に放置したと考えられる。昨晩書斎に立ち入った人物の特定が重要だ。',
    },
    {
      id: 'diary_entry',
      name: '日記の最終ページ',
      ...
      description:
        '故人の日記。「あの者には知らせていない。今夜の反応が見ものだ」という記述がある。',
      is_fake: false,
