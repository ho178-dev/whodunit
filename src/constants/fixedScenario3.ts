...
const FIXED_ACCUSATION_DATA_3: AccusationScenarioData = {
  correct: {
    ...
    wrong_link_rebuttal: '（静かに微笑む）……その程度の繋ぎで私に届くと思ったのか。つまらないな',
    refutation_text:
    ...
    epilogue_text:
      '月は西に傾き、山の夜が白みはじめていた。\n三百年の秘密は、ひとりの探偵の推理によって封じられた——あるいは、封じられたように見えた。\n夜は終わる。だが山は変わらない。次の満月を、静かに、待ち続けている。\n黒田は取り調べの中で、自らを「狂人」と名乗り始めた——三百年の人狼伝承に魅せられ、人狼の勝利を願って動いていた共犯者だった。白石星奈は本物の占い師として儀式を続けることを決め、大堂芳子は隠していた14年前の事件についても警察に証言した',
    escape_statement:
  ...
  incorrect: {
    kuroda_genichi: {
      ...
      wrong_link_rebuttal: '（鼻で笑う）……根拠が足りんな。もっと核心に迫るものを持ってこい',
      defeat_statement:
    ...
    shiraha_seira: {
      ...
      wrong_link_rebuttal: '（静かに首を振る）……論点が結ばれていない。もう一度整理してみてください',
      defeat_statement:
    ...
    tamura_shou: {
      ...
      wrong_link_rebuttal:
        '（焦った様子で）それと僕と、どう繋がるって言うんですか！ アリバイを確認してください！',
      defeat_statement:
    ...
    mizusawa_kana: {
      ...
      wrong_link_rebuttal:
        '（悲しそうに）そんな……話が繋がってないです。私は正直に話しているだけなのに',
      defeat_statement:
        '（ほっとした様子で）……やっと、わかってもらえましたか。正直に話していただけですから。',
    },
    odo_saburo: {
      defense_statement:
        '……私が人狼？（深くため息をついて）30年、この儀式を守ってきました。こんな形で疑われるとは思っていませんでしたが……仕方ありません。証拠を見てください。私には動機も手段もありません。',
      evidence_rebuttal: '……その証拠を持ってきてどうしようというのか。（静かに問う）',
      wrong_link_rebuttal: '（冷静に）論拠に飛躍がありますね。30年の経験から申し上げます',
      defeat_statement:
        '（静かに目を閉じて）……証拠が不十分だった。30年の経験からひとつだけ言えることがある——真実は、逃げない。',
    },
  },
}
  ...
  suspects: [
    {
      ...
      default_wrong_pursuit_response:
        '……それと私の行動、どう結びつくんでしょうね。（静かに首を傾げる）話が見えないな',
      confession_statement:
        '……（低く、静かに笑う）よく気づいた。本当に。\n知っていますか。私が民俗学を専攻したのは、自分を理解したかったからです。三百年、この山の血脈——それを「研究対象」として客観的に眺めていれば、制御できると思っていた。\n……だが、満月の夜だけは違う。論文も、知識も、意志も——全て無力になる。あの瞬間、私は人間ではない。\n青木さんには何の罪もなかった。ただ、そこにいただけだ。……これが、私の本質だよ。君は、いい探偵だ',
      description:
      ...
      investigation_dialog: {
        ...
        statements: [
          ...
          '深夜に変身する人影を見たと水沢さんが言っているそうですが……霧の深い夜に、窓越しですよ。見間違いじゃないですか。',
    ...
    },
    {
      ...
      occupation: '占星術師',
      default_wrong_pursuit_response:
        'それと私の発言、関係あるのか？ もっと筋の通った話を持ってきてほしい',
      description:
      ...
      evidence_reactions: {
        ...
        fake_oracle_result: {
          ...
          bystander_reactions: [
            {
              suspectId: 'shiraha_seira',
              text: '（静かに頷いて）……やはり。あなたの水晶からは何も感じなかった。ずっと違和感があったんです',
            },
            {
              suspectId: 'tamura_shou',
              text: '（声が震える）……じゃあ、僕を人狼だと言ったのは全部嘘だったんですか！ ひどい……！',
            },
          ],
        },
        old_knife: {
    ...
    },
    {
      ...
      occupation: '霊媒師',
      default_wrong_pursuit_response:
        'その話と手がかり——繋ぎ方が見えません。もう一度整理してみてください',
      description:
    ...
    },
    {
      ...
      occupation: '会社員',
      default_wrong_pursuit_response:
        'それが僕と結びつくとは思えないんですが。もう少し整理してもらえますか',
      description:
    ...
    },
    {
      ...
      occupation: '大学生',
      default_wrong_pursuit_response:
        'それは……少し違うように思うんですが。私の見方が違うでしょうか',
      description:
    ...
    },
    {
      ...
      age: 62,
      occupation: '民俗学者（退職）',
      default_wrong_pursuit_response: '繋がりが見えないように思いますね。私には判断しかねます',
      description:
