...
const FIXED_ACCUSATION_DATA_3: AccusationScenarioData = {
  correct: {
    ...
    decisive_evidence_id: 'oracle_result',
    wrong_evidence_reaction:
      '……それだけでは私を追い詰めることはできない。もっと核心に迫るものを出してほしいですね。',
    refutation_text:
      '白石星奈の占い結果書と、犯行現場で発見されたペンダント——伊沢のものと特定された個人の持ち物が揃った。本物の水晶が反応した「黒」の判定は偽造不可能であり、伊沢が「自室にいた」という主張はどちらの証拠によっても崩れる。人狼の正体は、三百年の血脈——温厚な笑顔の奥に潜んでいた。',
    breakdown_statement:
  ...
  incorrect: {
    kuroda_genichi: {
      ...
      alibi_reveal:
        '黒田玄一は「狂人」——人狼の側に立ちながら、人狼が誰かを知らない存在だった。彼の偽の占い結果は村人を混乱させるためのものだった。あなたが間違った告発をしたことで、本物の人狼は生き延びた。真犯人は——今この場で、あなたの失敗を笑っている。',
    },
    shiraha_seira: {
      confusion_statement:
        '……私が人狼？（首を振り、悲しそうに）違います。私は本物の占い師で、昨夜正確に人狼を特定した。どうして私を……もう一度、証拠を見てください。',
      alibi_reveal:
        '白石星奈は本物の占い師だった。昨夜の占いで正確に人狼を特定していた証拠は本物だ。彼女を告発したことで、最も信頼できる証人を追い詰めてしまった。真犯人は——まだそこにいる。',
    },
    tamura_shou: {
      confusion_statement:
        '……え！？ 私が人狼！？ 違います！ 黒田さんが嘘をついているんです！ アリバイを確認してください！ 私には夜通し一緒にいた証人がいます！',
      alibi_reveal:
        '田村翔は無実の村人だった。黒田玄一（狂人）が仕掛けた偽の占い結果に誘導された形となった。田村のアリバイは複数の証言で裏付けられており、本物の人狼は別にいる。真犯人は——まだそこにいる。',
    },
    mizusawa_kana: {
      confusion_statement:
        '……え、私が！？ 違います！ 私は昨夜見たことを正直に話しただけで……！ 私が嘘をついていたとでも思っているんですか！',
      alibi_reveal:
        '水沢加奈は無実の村人だった。彼女の目撃証言はむしろ事件解決の重要な鍵だった。証言の一部の細かな食い違いは、恐怖と混乱の中での記憶のズレに過ぎない。真犯人は——まだそこにいる。',
    },
    odo_saburo: {
      confusion_statement:
        '……わしが人狼？（深くため息をついて）60年、この儀式を守ってきた。こんな形で疑われるとは思っていなかったが……仕方ない。証拠を見てほしい。わしには動機も手段もない。',
      alibi_reveal:
        '大堂三郎は無実の村人だった。人狼に関する知識が逆に疑いを招いたが、それは長年の民俗学研究による知識に過ぎない。彼の証言は今も真実であり、真犯人を突き止める手がかりを含んでいる。真犯人は——まだそこにいる。',
    },
  },
}
...
export const FIXED_SCENARIO_3: Scenario = {
  ...
  suspects: [
    ...
    },
    {
      ...
      description:
        '黒いコートを好む中年男性。自称占い師で、この儀式には「本物の霊能を確かめるため」と言って毎年参加している。声は低く落ち着いているが、視線に油断ならない鋭さがある。',
    ...
    },
    {
      ...
      description:
        '真面目そうな印象の若い男性。この儀式には3年前から参加している。黒田から「人狼」と告発されて困惑しており、焦りが表情に出ている。',
      personality: '真面目で正直。不当な疑いに対しては強く反論する。',
      alibi: '大堂三郎と大広間で深夜2時頃まで話し込んでいた。',
      secret:
        '山歩きの護身用に銀色のナイフを持参していたが、場の雰囲気を考えて申告していなかった。',
      relationship_to_victim: '昨年も同じ儀式に参加した顔見知り。',
      room_id: 'room_storage',
      timeline: '20:30 夕食 → 22:00以降 大堂三郎と大広間で談笑 → 深夜2時頃就寝（大堂証言あり）',
      timeline_has_contradiction: false,
      investigation_dialog: {
        greeting:
    ...
    },
    {
      ...
      occupation: '民俗学者（退職）',
      default_wrong_pursuit_response:
        'うーむ、その証拠とその証言の間に矛盾があるとは、わしには判断しかねる。',
      description:
        '白髪で恰幅のいい老人。元民俗学者で、この儀式を30年前に「復活」させた人物。人狼に関する知識は参加者の誰よりも深い。田村のアリバイを保証できる立場にある。',
      ...
      investigation_dialog: {
        greeting:
          '（重くため息をついて）……青木君が……わしが呼んだ。責任を感じている。何でも聞いてくれ。',
        statements: [
          'この「月の夜の儀式」は300年以上続く古い慣わしだ。人狼の血筋が現れた時のために続けてきた。',
          '占いの結果が2つ出るのは「占い師対決」——どちらかが嘘をついている。それを見破るのが村人の知恵だ。',
          '長年この儀式に参加してきたが、本物の人狼が現れたことは、これまで一度もなかった。',
          '田村君は昨夜ずっとわしと話し込んでいた。深夜2時まで一緒だった。彼のアリバイはわしが保証する。',
          '人狼を見分けるには、爪痕と獣毛の一致が決定的証拠となる。昔の文献にそう書かれている。',
        ],
      },
      evidence_reactions: {
        claw_marks: {
          reaction: 'これが……。古い文献に記された人狼の爪痕と一致する。青木君が気の毒だ。',
          behavior: 'sad',
        },
        wolf_fur: {
          reaction: 'この毛……変身の証拠だ。本物の人狼が来たということか。',
          behavior: 'sad',
        },
        torn_clothes: {
          reaction:
            '変身時の衣服の破損は記録にある。これが本物なら、変身した人物の部屋を調べるべきだ。',
          behavior: 'calm',
        },
        oracle_result: {
          reaction: '白石さんの占い結果……本物の水晶による判定なら信頼できる。',
          behavior: 'calm',
        },
        divination_crystal: {
          reaction: 'これが白石さんの水晶か。使用痕がある——昨夜確かに使われた証拠だ。',
          behavior: 'calm',
        },
        bloody_footprint: {
          reaction: '足跡……犯行現場から誰かの部屋方向へ向かっている。丁寧に追えば犯人が分かる。',
          behavior: 'calm',
        },
        witness_memo: {
          reaction: '水沢さんの目撃記録。深夜0時——変身の時刻と合致する。',
          behavior: 'calm',
        },
        ritual_record: {
          reaction: '（目を細めて読む）……これは……14年前の記録も載っているのか。',
          behavior: 'nervous',
          contradicts_statement_index: 2,
          wrong_testimony_response:
            'その証言と、14年前の記録の存在に直接の矛盾があるとは言い切れない。',
          pursuit_questions: [
            {
              id: 'odo_pq_record_1',
              text: 'この記録には14年前にも人狼が現れて死者が出たと書かれています。あなたは知っていましたか？',
              response:
                '（長い沈黙）……そうだ。14年前に一人亡くなった。わしは……若い参加者に言わなかった。',
              behavior: 'sad',
            ...
            },
            {
              ...
              response:
                '（深く頭を垂れる）……怖がらせたくなかった。儀式を続けたかった。それが判断ミスだった。今回のことがあれば、最初から全員に告げておくべきだった——申し訳ない。',
              behavior: 'sad',
            },
          ],
        },
        lost_pendant: {
          reaction: '犯行現場のペンダント……どこかで見た気がするが。誰のものか思い出せん。',
          behavior: 'calm',
        },
        fake_oracle_result: {
          reaction: '黒田の結果書か……本物らしく作られているが、水晶の使用痕がない点が引っかかる。',
          behavior: 'calm',
        },
        old_knife: {
          reaction: '銀のナイフ……田村君が持っていたのか。しかしこれは登山用の道具のようだ。',
          behavior: 'calm',
        },
        dried_herbs: {
          reaction: '薬草か……山歩きで採取した傷薬だな。人狼とは無関係だ。',
          behavior: 'calm',
        },
      },
    },
  ...
  evidence: [
    ...
    },
    {
      ...
      examination_notes:
        '結果書に押された「水晶の印」を本物の占術水晶の印と比較すると、光の屈折跡のパターンが異なる。本物の水晶による印は内部の亀裂構造が独自のパターンを作るが、これは別の素材（おそらくガラス球）で模倣したものだ。また田村翔には深夜2時頃まで大堂三郎との同席が証言されており、犯行時刻の行動と矛盾する。',
    },
    {
      id: 'old_knife',
      name: '古い銀色のナイフ',
